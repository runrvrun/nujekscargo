<table>
    <thead>
    <tr>
        <th colspan=14 style="vertical-align:top;font-size: 14pt; text-align:center;"><strong>CARGO MANIFEST {{ $manifest->no_manifest }}</strong></th>
    </tr>
    <tr>
        <th colspan=14 style="vertical-align:top;font-size: 12pt; text-align:center;">No. &nbsp;&nbsp; / {{ $manifest->created_at->format("j F Y") }}</th>
    </tr>
    ...
    <tr>
        ...
        <td style="vertical-align:top;border-left:1px solid black;border-top:1px solid black;width:14"><strong>SPB</strong></td>
    ...
    <tr>
        ...
        <td style="vertical-align:top;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black"><strong>Berat Vol</strong></td>
    ...
    @foreach($spb as $s)
        ...
        @elseif($itemcount == 1)
            <tr>
                ...
                <td style="vertical-align:top;border-left:1px solid black;border-right:1px solid black;border-top:1px solid black">{{ $s->items[0]->length*$s->items[0]->width*$s->items[0]->height*$s->items[0]->bale/4000 }}<?php $stvolume+=$s->items[0]->length*$s->items[0]->width*$s->items[0]->height*$s->items[0]->bale/4000;?></td>
        ...
        @elseif($itemcount == 2)
            ...
            <tr>
                ...
                <td style="vertical-align:top;border-left:1px solid black;border-right:1px solid black">{{ $s->items[1]->length*$s->items[1]->width*$s->items[1]->height*$s->items[1]->bale/4000 }}<?php $stvolume+=$s->items[1]->length*$s->items[1]->width*$s->items[1]->height*$s->items[1]->bale/4000;?></td>
        ...
        @elseif($itemcount > 2)
            ...
            <tr>
                ...
                <td style="vertical-align:top;border-left:1px solid black;border-right:1px solid black">{{ $s->items[$i]->length*$s->items[$i]->width*$s->items[$i]->height*$s->items[$i]->bale/4000 }}<?php $stvolume+=$s->items[$i]->length*$s->items[$i]->width*$s->items[$i]->height*$s->items[$i]->bale/4000;?></td>
