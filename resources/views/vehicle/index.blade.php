        ...
        buttons: [
            {
              ...
              action: function ( e, dt, node, config ) {
                  window.location = '{{ url('vehicle/create') }}'
              }
            },  
            { extend: 'colvis', text: 'Column' },'copy', 'csv', 'excel', 'pdf', 'print',
            {
              ...
              action: function ( e, dt, node, config ) {
                  window.location = '{{ url('vehicle/csvall') }}'
              }
            },
            {
    ...
    $('.buttons-deletemulti').click(function(){
      ...
      if(deleteids_arr.length > 0){
        ...
        if (confirmdelete == true) {
          window.location = '{{ url('vehicle/destroymulti?id=') }}'+deleteids_str
        } 
      }
      });
});
